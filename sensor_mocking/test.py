...
class TestBHKW(unittest.TestCase):
    ...
    def testStartUp(self):
        self.assertEqual(self.BHKW.currentWorkload, 0)
        self.BHKW.turnOn()
        #assert, that BHKW doesnt immediatly work at deisred power
        self.assertTrue(self.BHKW.currentWorkload != 75)
        time.sleep(0.1)
        # but workload should still rise a bit
        self.assertTrue(self.BHKW.currentWorkload != 0)
    ...
    def testTurnOff(self):
        #set values directly
        self.BHKW.currentWorkload = 20.0
        ...
        self.assertEqual(self.BHKW.currentWorkload,0.0)

    def testMeasuredData(self):
        # values from vitobloc_200_EM datasheet
        self.BHKW._calculate(50.0)
        self.assertEqual(self.BHKW.currentElectricalPower,25)

        self.BHKW._calculate(75.0)
        self.assertEqual(self.BHKW.currentThermalPower, 64)
