...
class RuleStrategy(object):
    ...
    def validate_heatstorage_fill(self):
        ...
        (sim, measurements) = self.simulation_manager.forecast_for(
            FORECAST_TIME, blocking=True)
        ...
        if last_temp < sim.heat_storage.min_temperature:
            ...
            (sim1, measurements1) = self.simulation_manager.forecast_for(
                FORECAST_TIME, blocking=True, pre_start_callback=sim_settings)
