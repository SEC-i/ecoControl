...
def exponential_smoothing_step(input, index, 
...
def additive(x, m, forecast, alpha = None, beta = None, gamma = None):
    ...
    for i in range(len(Y) + forecast):
        ...
        exponential_smoothing_step(Y, i,(alpha, beta, gamma, None), (y, a, b, s, None), 1)
...
def multiplicative(x, m, forecast, alpha=None, beta=None, gamma=None, initial_values_optimization=[0.002, 0.0, 0.0002], optimization_type="RMSE"):
    ...
    for i in range(len(Y) + forecast+len(test_series)):
        ...
        exponential_smoothing_step(Y, i, (alpha, beta, gamma, None), (y, a, b, s, None), 2)
...
def double_seasonal(x, m, m2, forecast, alpha = None, beta = None, gamma = None,delta=None,
    ...
    for i in range(len(Y) + forecast+len(test_series)):
        ...
        exponential_smoothing_step(Y, i, (alpha, beta, gamma, delta, autocorrelation), (y, a, b, s, s2), 3)
