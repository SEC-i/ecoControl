var lang_en = {
    ...
    apply: 'Apply',
    auto_optimize_explanation: ' This optimization incorporates the cost of the device and tries to find the most cost-effective parameters. It uses the simulation as well as the load forecasts, to predict future device costs. When activate, immediate feedback is unavailable due to long calculation times.',
